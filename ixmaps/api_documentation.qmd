...
|--------|------|---------|-------------|
| `mapType` | string | `"VT_TONER_LITE"` | Basemap style — see [Map Types](map_types.qmd) |
...
The type string is composed by piping modifiers with `|`. See [Map Types, Sizing & Colors](map_types.qmd) for the full reference.
